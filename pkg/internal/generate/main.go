...
func main() {
	...
	// Header: package declaration + generated file marker, then open var block.
	// Helper types (intRef, commonPackageInfo, toPackageInfo) live in
	// rpmdb_testcase_helpers_test.go and are not generated.
